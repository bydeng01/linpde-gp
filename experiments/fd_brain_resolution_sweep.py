...
print(
    f"{'stride':>6} {'spacing_mm':>10} {'gridDOF':>8} {'bdryPts':>8} {'Pearson':>8} {'relerr':>7} {'nEval':>6}"
)
print(
    f"{1:>6d} {zooms[0]:>10.1f} {'307518':>8} {'88650':>8} {0.855:>8.3f} {0.296:>7.3f} {2000:>6d}  (full res, from prior run)"
)
for s in (2, 3, 4, 5, 6, 8):
    ...
    print(
        f"{s:>6d} {zooms[0]*s:>10.1f} {nD:>8d} {nb:>8d} {p:>8.3f} {rel:>7.3f} {int(ok.sum()):>6d}"
    )
