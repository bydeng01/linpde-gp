...
class ScaledLinearFunctionOperator(LinearFunctionOperator):
    ...
    def adjoint(self):
        return ScaledLinearFunctionOperator(
            self._linfuncop.adjoint(), scalar=np.conjugate(self._scalar)
        )
...
class CompositeLinearFunctionOperator(LinearFunctionOperator, Generic[T]):
    ...
    def adjoint(self):
        return CompositeLinearFunctionOperator(
            *(linfuncop.adjoint() for linfuncop in reversed(self._linfuncops))
        )
