...
class LinearFunctionOperator:
    ...
    def adjoint(self) -> "LinearFunctionOperator":
        """Adjoint with respect to the output space.

        By default linear function operators are assumed self-adjoint. Operators
        with non-symmetric output couplings (e.g. real-valued representations of
        complex operators) should override this to return the transpose /
